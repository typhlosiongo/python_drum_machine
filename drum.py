...
WIDTH = 1400
HEIGHT = 800
FONT = 'Futura Condensed Bold.otf'
black = (0,0,0)
white = (255, 255, 255)
gray  = (128, 128, 128)
dark_gray = (50, 50, 50)
...
label_font = pygame.font.Font(FONT, 32)
medium_font = pygame.font.Font(FONT, 24)
index = 100
fps = 60
...
def draw_grid(clicks, beat, actives):
    ...
    floor_tom = label_font.render('TOM', True, colors[actives[5]])
...
while run:
    ...
    beats_text = label_font.render('BEATS IN LOOP', True, white)
    screen.blit(beats_text, (605, HEIGHT-130))
